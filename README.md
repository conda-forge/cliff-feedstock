About cliff-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cliff-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=159&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cliff-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cliff` can be installed with `conda`:
...
It is possible to list all of the versions of `cliff` available on your platform with `conda`:
...
```
mamba search cliff --channel conda-forge
```
...
mamba repoquery search cliff --channel conda-forge

# List packages depending on `cliff`:
mamba repoquery whoneeds cliff --channel conda-forge

# List dependencies of `cliff`:
mamba repoquery depends cliff --channel conda-forge
```
